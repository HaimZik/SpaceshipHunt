	...
	public class PDParticleSystem extends ParticleSystem
	{
		...
		protected override function initParticle(aParticle:Particle):void
		{
			...
			if (_startColorVariance.red != 0)
				startColor.red += _startColorVariance.red * (Math.random() * 2.0 - 1.0);
			if (_startColorVariance.green != 0)
				startColor.green += _startColorVariance.green * (Math.random() * 2.0 - 1.0);
			if (_startColorVariance.blue != 0)
				startColor.blue += _startColorVariance.blue * (Math.random() * 2.0 - 1.0);
			if (_startColorVariance.alpha != 0)
				startColor.alpha += _startColorVariance.alpha * (Math.random() * 2.0 - 1.0);
			...
			if (_endColorVariance.red != 0)
				endColorRed += _endColorVariance.red * (Math.random() * 2.0 - 1.0);
			if (_endColorVariance.green != 0)
				endColorGreen += _endColorVariance.green * (Math.random() * 2.0 - 1.0);
			if (_endColorVariance.blue != 0)
				endColorBlue += _endColorVariance.blue * (Math.random() * 2.0 - 1.0);
			if (_endColorVariance.alpha != 0)
				endColorAlpha += _endColorVariance.alpha * (Math.random() * 2.0 - 1.0);
		...
		protected override function advanceParticle(aParticle:Particle, passedTime:Number):void
		{
			...
			{
				if (particle.radialAcceleration)
				{
				...
				{
					particle.velocityX += passedTime * _gravityX;
					particle.velocityY += passedTime * _gravityY;
				}
