...
<html>
    <head>
        <title>ברוך הבא ל<? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.co.il/"><img src="http://www.hostinger.co.il/images/logo-il.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>חשבונך נוצר בהצלחה!</h1>
                    <p>האתר <? print $host; ?> הותקן בהצלחה בשרת! אנא מחק את הקובץ default.php מתיקיית public_html ולאחר מכן העלה את אתרך על ידי שימוש בFTP או במנהל הקבצים.</p>
                    <p>הנה רשימה של קבצים בתיקיית public_html שלך:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.co.il/web-hosting" target="_blank">אחסון אתרים</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.co.il/free-hosting" target="_blank">אחסון חינמי</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.co.il/forum" target="_blank">פורום תמיכה</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.co.il/" target="_blank">אנא התחבר</a>
                </div>
                <div class="copyright">Hostinger מְדִינַת יִשְׂרָאֵל &copy; <? print date('Y'); ?>. All rights reserved</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.co.il"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
